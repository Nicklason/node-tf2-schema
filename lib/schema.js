...
class Schema {
    ...
    getItemByDefindex (defindex) {
        ...
        const iterLim = Math.ceil(Math.log2(this.raw.schema.items.length)) + 2;
        while (start <= end) {
            if(iterLim<=0){
    ...
    getAttributeByDefindex (defindex) {
        ...
        const iterLim = Math.ceil(Math.log2(this.raw.schema.attributes.length)) + 2;
        while (start <= end) {
            if(iterLim<=0){
                break;//use fallback search
            }
    ...
    getEffectById (id) {
        ...
        const iterLim = Math.ceil(Math.log2(this.raw.schema.attribute_controlled_attached_particles.length)) + 2;
        while (start <= end) {
            if(iterLim<=0){
                break;//use fallback search
            }
